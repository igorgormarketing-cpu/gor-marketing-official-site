...
if (Object.values(S_A11Y).some(Boolean)) {
    ...
    if (document.readyState === 'complete') {
        if ('requestIdleCallback' in window) {
            requestIdleCallback(startInteractive, { timeout: 4000 });
        } else {
    ...
    ['touchstart', 'mousedown', 'keydown', 'scroll'].forEach(function(e) {
        window.addEventListener(e, startInteractive, { once: true, passive: true });
    });
})();
