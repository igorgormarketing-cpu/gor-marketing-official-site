...
if (Object.values(S_A11Y).some(Boolean)) {
    ...
    if (document.readyState === 'complete') {
        if ('requestIdleCallback' in window) {
            requestIdleCallback(runGorEngine, { timeout: 3000 });
        } else {
            setTimeout(runGorEngine, 1000);
        }
    } else {
    ...
    ['touchstart', 'mousedown', 'mousemove', 'keydown', 'scroll'].forEach(function(evt) {
        window.addEventListener(evt, runGorEngine, { once: true, passive: true });
    });
})();
